...
export const translations = {
  en: {
    ...
    hero: {
      ...
      headline1: "Move. Connect.",
      headline2: "Evolve.",
      sub: "More connected teams. More present people. Better performance. At EVOX we design experiences that help people reconnect with their body, their team, and their purpose.",
      cta: "Ver Programas",
    },
    about: {
      badge: "about EVOX",
      title: "The problem is not talent.",
      subtitle: "It's the environment where people live and work.",
      p1title: "Silent Burnout",
      p1body: "Teams running on autopilot, with less energy, focus, and motivation.",
      p2title: "Human Disconnection",
      p2body: "Less presence. Less real collaboration. More distance between people.",
      p3title: "Blocked Creativity",
      p3body: "When stress takes over, performance and good ideas start to disappear.",
      p4title: "Worn-Out Culture",
      p4body: "People don't leave companies. They leave environments where they stopped feeling alive.",
    },
    howItWorks: {
      wellnessBadge: "Evox Wellness",
      wellnessTitle: "Wellbeing is the foundation.",
      wellnessSub: "When teams reconnect with their body and energy, they improve the way they work, lead, and collaborate. That's why at EVOX we create programs and experiences that generate connection, transformation, and real evolution.",
      howBadge: "How It Works",
      howTitle: "Why Evox Works: Challenge the body, calm the mind, connect the team. Results you can feel and measure.",
      benefitsLabel: "Benefits",
      wellness: [
        { title: "Fitness Sessions", desc: "group classes, personal training, corporate fitness programs" },
        { title: "Fisioterapia", desc: "massages, rehab, prevention, corporate sessions" },
        { title: "Workshops & Mindfulness", desc: "meditation, breathwork, stress-reduction workshops" },
        { title: "Pausas Activas", desc: "short movement & ergonomic pauses in workplace" },
      ],
      steps: [
    ...
    pricing: {
      ...
      form: {
        ...
        companySizePlaceholder: "Select team size",
  ...
  es: {
    ...
    hero: {
      ...
      headline1: "Move. Connect.",
      headline2: "Evolve.",
      sub: "Equipos más conectados. Personas más presentes. Mejor rendimiento. En EVOX diseñamos experiencias que ayudan a las personas a reconectar con su cuerpo, su equipo y su propósito.",
      cta: "Ver Programas",
    },
    about: {
      badge: "sobre EVOX",
      title: "El problema no es el talento.",
      subtitle: "Es el entorno en el que las personas viven y trabajan.",
      p1title: "Burnout silencioso",
      p1body: "Equipos funcionando en automático, con menos energía, foco y motivación.",
      p2title: "Desconexión humana",
      p2body: "Menos presencia. Menos colaboración real. Más distancia entre las personas.",
      p3title: "Creatividad bloqueada",
      p3body: "Cuando el estrés domina, el rendimiento y las buenas ideas empiezan a desaparecer.",
      p4title: "Cultura desgastada",
      p4body: "Las personas no abandonan empresas. Abandonan entornos donde dejaron de sentirse vivas.",
    },
    howItWorks: {
      wellnessBadge: "Bienestar Evox",
      wellnessTitle: "El bienestar es la base de los equipos",
      wellnessSub: "Cuando los equipos reconectan con su cuerpo y su energía, mejoran la forma en la que trabajan, lideran y colaboran. Por eso en EVOX creamos programas y experiencias que generan conexión, transformación y evolución real.",
      ...
      wellness: [
        { title: "Fitness Sessions", desc: "clases grupales, entrenamiento personal, programas de fitness corporativo" },
        { title: "Fisioterapia", desc: "masajes, rehabilitación, prevención, sesiones corporativas" },
        { title: "Workshops & Mindfulness", desc: "meditación, respiración, talleres de reducción del estrés" },
    ...
    pricing: {
      ...
      form: {
        ...
        companySizePlaceholder: "Selecciona el tamaño del equipo",
